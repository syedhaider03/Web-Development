	...
	<html lang="en">
		...
		<a href="index.php" class="logo pull-left"><img src="themes/images/logo.png" class="site_logo" alt=""></a>
			...
			<div class=" " align="center">
				<div class="span4" >
					<form  style="margin :auto;margin-bottom: 15%;width: auto;margin-top: 20%" method="POST" class="form-inline my-2 my-lg-0"> 
      <table ><tr><td><input class="form-control mr-sm-2" placeholder="Search" name="srch-term" id="srch-term" type="text" style="width: 100%;height: 30px;margin-bottom: -20px;margin-top: -1px;align-self: center;color: black"></td>
              <td><button class="btn btn-default" type="submit" style="margin-bottom: -20px;margin-top: -1px"><i class="glyphicon glyphicon-search btn-outline-success my-2 my-sm-0"></i></button></td></tr>
<!-- 
